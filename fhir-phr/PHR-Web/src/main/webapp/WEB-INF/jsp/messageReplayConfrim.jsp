...
$(function() {
    ...
    function complite(){
        var flg = ${messageReplayConfirmForm.status};
    ...
    function messageReturn(command) {
...
<form:form modelAttribute="messageReplayConfirmForm" name="messageReplayConfirmForm" action="${action}">
...
<div class="message-list" style="height:390px;">
	...
	<div id="returnwindow">
		...
		<tr>
            ...
            <table class="green-header">
                <tr>
                    ...
                    <td class="r300 center">
                        <c:if test="${not empty messageDto.phrid}">
            ...
            <a href="javascript:messageReturn('return');" class="button button-blue" name="return" id="return" style="display: '';"><span>戻る</span></a>
