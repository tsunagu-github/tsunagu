...
$(function() {
    ...
    function complite(){
        var flg = ${medicalMessageReplayConfirmForm.status};
...
<form:form modelAttribute="medicalMessageReplayConfirmForm" name="medicalMessageReplayConfirmForm" action="${action}">
	...
	<div id="returnwindow">
            ...
            <table class="green-header">
                <tr>
                    ...
                    <td class="r300 center">${messageDto.patientId}</td>
                </tr>	
		<tr>
