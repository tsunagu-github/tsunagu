/*
 * JAHIS 電子お薬手帳データフォーマット仕様書 Ver2.1準拠レコードNo
 */
package phr.dto;
 ...
 * @author iwaasa
 */
public enum MedicineFormatRecordNo {
	/**
	 * 仕様書：患者情報レコード
	...
	private MedicineFormatRecordNo(String id)
	{
		this.id = id;
	}
	 ...
	 * @return 対応するオブジェクト
	 */
	public static MedicineFormatRecordNo parse(String s)
	{
	 ...
	 * @return
	 */
	public static List<MedicineFormatRecordNo> getList() {
		List<MedicineFormatRecordNo> list = new ArrayList();
