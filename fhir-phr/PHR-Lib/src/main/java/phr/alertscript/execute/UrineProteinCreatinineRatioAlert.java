 ...
 * @author kis-note
 */
public class UrineProteinCreatinineRatioAlert  implements IAlertExecuteService {

    /**
     * ロギングコンポーネント
     */
    private static final Log logger = LogFactory.getLog(UrineProteinCreatinineRatioAlert.class);
   /**
     * 抽出を行うメインサービス
     * @param
     * @return
