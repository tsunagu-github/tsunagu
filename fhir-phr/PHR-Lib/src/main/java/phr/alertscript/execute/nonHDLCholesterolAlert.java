 ...
 * @author kis-note
 */
public class nonHDLCholesterolAlert  implements IAlertExecuteService {

    /**
     * ロギングコンポーネント
     */
    private static final Log logger = LogFactory.getLog(nonHDLCholesterolAlert.class);
   /**
     * 抽出を行うメインサービス
     * @param entity
     * @param target
    ...
    private Double getLimitValue(String sexCd,int age, boolean highliskflg,int factorcount,boolean caDiseaseflg){
        Double specialLisk = 130.0;
        Double heighLisk = 150.0;
        Double middleLisk = 170.0;
        Double lowLisk = 190.0;
