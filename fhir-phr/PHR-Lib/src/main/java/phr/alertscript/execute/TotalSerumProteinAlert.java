 ...
 * @author kis-note
 */
public class TotalSerumProteinAlert  implements IAlertExecuteService {

    /**
     * ロギングコンポーネント
     */
    private static final Log logger = LogFactory.getLog(TotalSerumProteinAlert.class);
   /**
     * 抽出を行うメインサービス
     * @param
     * @return
