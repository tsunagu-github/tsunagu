 ...
 * @author kis-note
 */
public class SerumAlbuminAlert  implements IAlertExecuteService {

    /**
     * ロギングコンポーネント
     */
    private static final Log logger = LogFactory.getLog(SerumAlbuminAlert.class);
   /**
     * 抽出を行うメインサービス
     * @param
     * @return
