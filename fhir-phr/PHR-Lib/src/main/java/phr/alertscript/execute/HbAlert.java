 ...
 * @author kis-note
 */
public class HbAlert  implements IAlertExecuteService {

    /**
     * ロギングコンポーネント
     */
    private static final Log logger = LogFactory.getLog(HbAlert.class);
   /**
     * 抽出を行うメインサービス
     * @param
     * @return
	...
	public Integer getAlert(ObservationDefinitionScriptEntity entity, ObservationEntity target,PatientEntity pentity,Timestamp date) throws Throwable{
            ...
            //単体チェック
            if(d_value < 9.0 || d_value > 18.0) return 1;
