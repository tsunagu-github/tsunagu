...
public enum PrefectureCdEnum {
     ...
     * ロギングコンポーネント
     */
    private static final Log logger = LogFactory.getLog(PrefectureCdEnum.class);
    ...
    */
    ...
    PrefectureCdEnum(final String ancode , String anname) {
        code = ancode;
        name = anname;
    }
