 ...
 * 
 */
public class ToModelValidate {

    /**
    * ロギングコンポーネント
    */
    private static final Log logger = LogFactory.getLog(ToModelValidate.class);
    ...
    */
     ...
     * @parm type データ種別
    */
    public boolean saveValidation(File file , String type){
        logger.debug("start");
        logger.debug(type + "の取得Validationを開始");
